...
INSERT INTO `menu` (`id`,`parent_id`,`seq`,`title`,`uri`,`type`) VALUES (6,'1','11','查询教师','/teacherManager/toQuery.do','2');
...
INSERT INTO `menu` (`id`,`parent_id`,`seq`,`title`,`uri`,`type`) VALUES (10,'4','11','导入学生信息','/namelist/importStudent.do','2');
...
INSERT INTO `menu` (`id`,`parent_id`,`seq`,`title`,`uri`,`type`) VALUES (15,'12','11','查询学生','/studentManager/toQuery.do','0');
INSERT INTO `menu` (`id`,`parent_id`,`seq`,`title`,`uri`,`type`) VALUES (16,'13','11','修改信息','/personal/modifyInfo.do','0');
